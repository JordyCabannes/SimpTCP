 ...
 * \brief structure regroupant toutes les variables d'etat specifiques a un socket simpTCP
 *
*/
struct simptcp_socket { /* SimpTCP Protocol Control Block */
  ...
  char nbr_retransmit; /*!< number of times first unacked message simptcp_generic_header
 ...
 * in time. The simpTCP_socket_states struct wraps all these up and a
 ...
 * simpTCP socket state. For example,  active_open is called 
