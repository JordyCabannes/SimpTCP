...
/*! \fn void simptcp_get_flags  (char *buffer)
...
/*! \fn void simptcp_get_seq_num (char *buffer)
...
/*! \fn void simptcp_set_total_len   (char *buffer, unsigned char tlen)
...
/*! \fn void simptcp_get_win_size  (char *buffer)
...
/*! 12903 \fn int simptcp_check_checksum(char *buffer, int len)
...
int simptcp_check_checksum(char *buffer, int len)
{
    ...
    //printf("checksum du buffer d'entree : %d ",simptcp_get_checksum(buffer)) ;   
    ...
    //printf("buffer ou l'on fait le checksum \n") ;
    //simptcp_print_packet(buffer);
    //printf("calcul des checksum , checksum : %d , buffer :%d  ",checksum , ntohs(header->checksum) ) ;
...
void simptcp_lprint_packet (char * buf)
{
    ...
    printf ("+----------------+-----------------+-------------------+\n");
    printf ("| acknum : %5hu | hlen : %3d  | Flags : %7s|\n",
